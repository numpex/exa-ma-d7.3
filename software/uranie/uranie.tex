...
\subsection{Software: Uranie}
\label{sec:Uranie:software:training}
...
CPU Only\\
\end{tabular} \\
        \rowcolor{white}\textbf{Repository} & \href{uranie.cea.fr}{uranie.cea.fr} \\
...
\subsubsection{Next Steps for Uranie}
\label{sec:Uranie:next-steps}

Below are some guiding questions to help outline the next steps for training with Uranie:
\begin{itemize}
    \item What new training content or updates are planned for Uranie in the upcoming milestones?
