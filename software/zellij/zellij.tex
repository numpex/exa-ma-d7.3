...
\subsubsection{Next Steps for Zellij}
\label{sec:Zellij:next-steps}

Below are some guiding questions to help outline the next steps for training with Zellij:
\begin{itemize}
    \item What new training content or updates are planned for Zellij in the upcoming milestones?
