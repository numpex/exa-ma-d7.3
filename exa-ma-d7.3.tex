...
\delivFPAuthor{Florent Faucher (INRIA), Christos Georgiadis (INRIA), Luc Giraud (INRIA), Loic Gouarin (CNRS, EP), Guillaume Helbecque (U Lille), Pierre Jolivet (CNRS, SU), Gilles Marait (INRIA), Victor Michel Dansac (INRIA), Pierre-Henri Tournier (CNRS, SU), Sébastien Tordeux (UPPA)}
...
%%% Change Log
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\istChange{15/04/2025}{v1.0.1}{Pierre Jolivet (CNRS, SU), Christophe Prud'homme (UNISTRA)}{fix CITATION.cff and add .zenodo.json}
\istChange{10/04/2025}{v1.0.0}{Pierre Jolivet (CNRS, SU), Christophe Prud'homme (UNISTRA), Sébastien Tordeux (UPPA)}{final version and updated master track information}
\istChange{11/03/2025}{v0.5.0}{Victor Michel Dansac (INRIA), Florent Faucher (INRIA), Luc Giraud (INRIA), Loic Gouarin (CNRS), Guillaume Helbecque (U Lille), Gilles Marait (INRIA), Christophe Prud'homme (UNISTRA)}{added software training information: Composyx, Hawen, pBB, Samurai, Scimba}
\istChange{02/03/2025}{v0.4.0}{Pierre Jolivet (CNRS, Paris Sorbonne), Christophe Prud'homme (UNISTRA)}{added software training information: HPDDM}
\istChange{11/02/2025}{v0.3.0}{Christos Georgiadis (INRIA), Christophe Prud'homme (UNISTRA), Pierre Henri Tournier (SU), Pierre Jolivet (CNRS, Paris Sorbonne)}{added software training information: CGAL, FreeFEM++ and Feel++}
\istChange{05/02/2025}{v0.2.0}{Christophe Prud'homme (UNISTRA)}{Cleanup; update intro and conclusion; add Master track internship trainings and request form}
\istChange{04/02/2025}{v0.1.0}{Christophe Prud'homme (UNISTRA)}{First draft report}
