...
\delivFPAuthor{Florent Faucher (INRIA), Christos Georgiadis (INRIA), Luc Giraud (INRIA), Loic Gouarin (CNRS), Guillaume Helbecque (U Lille), Pierre Jolivet (CNRS, Paris Sorbonne), Gilles Marait (INRIA), Victor Michel Dansac (INRIA), Pierre Henri Tournier (SU), Sébastien Tordeux (UPAU)}
