...
\delivFPAuthor{Florent Faucher (INRIA), Christos Georgiadis (INRIA), Luc Giraud (INRIA), Loic Gouarin (CNRS), Guillaume Helbecque (U Lille), Pierre Jolivet (CNRS, Paris Sorbonne), Gilles Marait (INRIA), Victor Michel Dansac (INRIA), Pierre Henri Tournier (SU), Sébastien Tordeux (UPPA)}
...
%%% Change Log
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\istChange{10/04/2025}{v1.0.0}{Christophe Prud'homme (UNISTRA), Sébastien Tordeux (UPPA)}{final version and updated master track information}
