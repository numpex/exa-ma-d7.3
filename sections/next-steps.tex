...
Currently, each Exa-MA software stack (e.g., \textit{Arcane}, \textit{FreeFem++}, \textit{Feel++}, \textit{HPDDM}, \textit{Mmg/Parmmg}, etc.) offers preliminary tutorials, user guides, or workshop slides (see Table~\ref{tab:software-training}). 
%
...
\begin{itemize}
    \item \textbf{At least XX\%} of existing tutorials upgraded with advanced HPC examples (GPU usage, multi-node scaling).
